    ...
    return (
      <div className="Main">
        ...
        <Switch>
            ...
            <Route path="/groups" render={(navProps) => <Groups {...navProps} groups={{test: {name: 'cliquer', members: [], id: 'test'}}} />}/>
            ...
            <Route path="/search/:category/:query" render={(navProps) => <SearchResults {...navProps} {...this.props} results={[{name: 'Jordan', reputation: '42'}]} />}/>
